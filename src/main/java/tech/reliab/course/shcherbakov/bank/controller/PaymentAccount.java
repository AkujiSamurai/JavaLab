...
public class PaymentAccount{
    ...
    @PostMapping
    public ResponseEntity<tech.reliab.course.shcherbakov.bank.entity.PaymentAccount> createPaymentAccount(PaymentAccountRequest paymentAccountRequest) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<tech.reliab.course.shcherbakov.bank.entity.PaymentAccount> updatePaymentAccount(int id, int bankId) {
        return ResponseEntity.ok(paymentAccountService.updatePaymentAccount(id, bankId));
    }

    @GetMapping("/{id}")
    public ResponseEntity<tech.reliab.course.shcherbakov.bank.entity.PaymentAccount> getBankByPaymentAccount(int id) {
        return ResponseEntity.ok(paymentAccountService.getPaymentAccountDtoById(id));
    }

    @GetMapping
    public ResponseEntity<List<tech.reliab.course.shcherbakov.bank.entity.PaymentAccount>> getAllPaymentAccounts() {
